# Contributing to simple-moving-avg

First and foremost, thank you! We appreciate that you want to contribute to simple-moving-avg, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for simple-moving-avg**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for simple-moving-avg:

- star the [project](https://github.com/doowb/simple-moving-avg)
- tweet your support for simple-moving-avg
...
- **version**: please note the version of simple-moving-avg are you using
...
[so]: http://stackoverflow.com/questions/tagged/simple-moving-avg